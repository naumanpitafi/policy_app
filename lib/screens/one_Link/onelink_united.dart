...
class OneLinkUnited extends StatefulWidget {
  const OneLinkUnited({Key? key}) : super(key: key);

  @override
  State<OneLinkUnited> createState() => _OneLinkUnitedState();
}

class _OneLinkUnitedState extends State<OneLinkUnited> {
  @override
            ...
            child: Column(
              ...
              children: [
                SizedBox(
                  ...
                  height: 44.h,
                  child: const Image(
                    image: AssetImage(AppImages.unitedLogo),
                  ),
                ),
                text(
                  context,
